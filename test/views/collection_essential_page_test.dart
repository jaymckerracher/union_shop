...
void main() {
  testWidgets(
      'CollectionEssentialPage displays header, title, filter bar, product count, and footer',
      (WidgetTester tester) async {
    await tester.pumpWidget(const MaterialApp(
      home: CollectionEssentialPage(),
    ));
    // Header
    expect(find.byType(Header), findsOneWidget);
    // Title
    expect(find.text('Essential Collection'), findsOneWidget);
  ...
  testWidgets('CollectionEssentialPage opens drawer when menu icon tapped',
      (WidgetTester tester) async {
    await tester.pumpWidget(const MaterialApp(
      home: CollectionEssentialPage(),
    ));
  ...
  testWidgets('CollectionEssentialPage displays correct product count',
      (WidgetTester tester) async {
    await tester.pumpWidget(const MaterialApp(
      home: CollectionEssentialPage(),
    ));
    // The default ProductsViewModel(collection: signatureAndEssentialRange) is empty unless populated in the app
