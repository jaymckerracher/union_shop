...
void main() {
  testWidgets(
      'CollectionHalloweenPage displays header, title, filter bar, product count, and footer',
      (WidgetTester tester) async {
    await tester.pumpWidget(const MaterialApp(
      home: CollectionHalloweenPage(),
    ));
    // Header
    expect(find.byType(Header), findsOneWidget);
    // Title
    expect(find.text('Halloween Collection'), findsOneWidget);
  ...
  testWidgets('CollectionHalloweenPage opens drawer when menu icon tapped',
      (WidgetTester tester) async {
    await tester.pumpWidget(const MaterialApp(
      home: CollectionHalloweenPage(),
    ));
  ...
  testWidgets('CollectionHalloweenPage displays correct product count',
      (WidgetTester tester) async {
    await tester.pumpWidget(const MaterialApp(
      home: CollectionHalloweenPage(),
    ));
    // The default ProductsViewModel(collection: halloween) is empty unless populated in the app
