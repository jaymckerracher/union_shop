...
class ProductsRepository {
  final List<Product> products = [
    Product(
      ...
      price: 12.00,
      imageUrls: [
        'images/classic_beanie/black.webp',
        'images/classic_beanie/green.webp',
        'images/classic_beanie/purple.webp',
    ...
    Product(
      ...
      price: 12.00,
      imageUrls: [
        'images/classic_cap/black.webp',
        'images/classic_cap/green.webp',
        'images/classic_cap/grey.webp',
        'images/classic_cap/purple.webp',
      ],
      category: ProductCategory.clothing,
      collections: [],
    ),
    Product(
      ...
      price: 25.00,
      imageUrls: [
        'images/classic_hoodie/blue.webp',
        'images/classic_hoodie/green.webp',
        'images/classic_hoodie/grey.webp',
        'images/classic_hoodie/purple.webp',
      ],
      category: ProductCategory.clothing,
      collections: [],
    ),
    Product(
      ...
      price: 12.99,
      imageUrls: [
        'images/classic_rainbow_hoodie/black.webp',
      ],
      originalPrice: 30.00,
    ...
    Product(
      ...
      price: 23.00,
      imageUrls: [
        'images/classic_sweatshirt/black.webp',
        'images/classic_sweatshirt/green.webp',
        'images/classic_sweatshirt/grey.webp',
        'images/classic_sweatshirt/purple.webp',
      ],
      category: ProductCategory.clothing,
      collections: [],
    ),
    Product(
      ...
      price: 11.00,
      imageUrls: [
        'images/classic_tee/black.webp',
        'images/classic_tee/blue.webp',
        'images/classic_tee/purple.webp',
        'images/classic_tee/white.webp',
      ],
      category: ProductCategory.clothing,
      collections: [],
    ),
    Product(
      ...
      price: 6.99,
      imageUrls: [
        'images/essential_tee/blue.webp',
        'images/essential_tee/green.webp',
      ],
      originalPrice: 10.00,
    ...
    Product(
      ...
      price: 35.00,
      imageUrls: [
        'images/grad_hoodie/grey.webp',
        'images/grad_hoodie/purple.webp',
      ],
      category: ProductCategory.clothing,
    ...
    Product(
      ...
      price: 32.99,
      imageUrls: [
        'images/signature_hoodie/green.webp',
        'images/signature_hoodie/white.webp',
      ],
      category: ProductCategory.clothing,
      collections: [Collections.signatureAndEssentialRange],
    ),
    Product(
      ...
      price: 14.99,
      imageUrls: [
        'images/signature_tee/blue.webp',
        'images/signature_tee/white.webp',
      ],
      category: ProductCategory.clothing,
      collections: [Collections.signatureAndEssentialRange],
    ),
    ...
    Product(
      ...
      price: 10.99,
      imageUrls: [
        'images/merch/crested_tie.webp',
      ],
      originalPrice: 15.00,
      promoMessage: 'Special offer: Save £4 today!',
      category: ProductCategory.merchandise,
      collections: [],
    ),
    Product(
    ...
    Product(
      ...
      price: 2.75,
      imageUrls: [
        'images/merch/rainbow_lanyard.webp',
      ],
      category: ProductCategory.merchandise,
      collections: [Collections.prideCollection],
    ),
    Product(
      ...
      price: 5.50,
      imageUrls: [
        'images/merch/usb.webp',
      ],
      originalPrice: 7.50,
      promoMessage: 'Was £7.50, now just £5.50!',
      category: ProductCategory.merchandise,
      collections: [],
    ),
  ];
